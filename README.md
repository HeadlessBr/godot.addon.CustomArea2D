...
-Como integrar?
 ...
 -Como configurar os grupos que aparecem em Group
 Entre no script 'config.gd' e coloque os nomes dos grupos desejados como valores em String dentro do Array 'groups'
